...
function dl_enqueue_style() {
	...
	wp_register_style( 'google_font', 'https://fonts.googleapis.com/css?family=Overpass:300,600&display=swap');
	wp_register_style( 'my_style', get_theme_file_uri( '/assets/css/my_style.css'), 'main_style', $theme_data->get( 'Version' ), 'screen' );
